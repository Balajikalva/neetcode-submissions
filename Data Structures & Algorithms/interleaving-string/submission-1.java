class Solution {
    ...
    public boolean helper(String s1, String s2, String s3, int l1, int l2, int l3) {
        ...
        if (dp[l1][l2][l3] != null) return dp[l1][l2][l3];

        if (s1.charAt(l1) == s3.charAt(l3)) {

            if (helper(s1, s2, s3, l1 + 1, l2 , l3 + 1)) return dp[l1][l2][l3] = true;
        }

        if (s2.charAt(l2) == s3.charAt(l3)) {
            if (helper(s1,s2,s3, l1, l2 + 1, l3 + 1)) return dp[l1][l2][l3] = true;
        }

        return dp[l1][l2][l3] = false;
